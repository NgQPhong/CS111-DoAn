...
class Icon:
    def __init__(self):
        ...
        self.icon = dict({
            ...
            "load_memory": PhotoImage(file=join(self.path, "load_memory.png")),
            "write_value": PhotoImage(file=join(self.path, "write_value.png")),
            "rewrite_value": PhotoImage(file=join(self.path, "rewrite_value.png")),
            "built": PhotoImage(file=join(self.path, "built.png")),
